...
/**
 * This method will generate stylesheet with colors, matching current IDE colors,
 * for markdown elements. Generated rules will override base rules from the
 * default.css and darcula.css, so the preview elements will have correct (almost) colors.
 *
 * @return String containing generated CSS rules.
 */
internal fun createStyleOverrides(): String {
